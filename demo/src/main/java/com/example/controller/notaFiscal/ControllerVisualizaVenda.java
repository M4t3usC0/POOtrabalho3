...
public class ControllerVisualizaVenda {
    ...
    /**
     * btnInformacaoTodosProdutos usado para mostrar as informações de todas as notas fiscais
     */
    @FXML
    private Button btnInformacaoTodasNotas;
    
    /**
     * btnInformacaoDiaEspecifico usado para mostrar as informações de um dia específico
     */
    @FXML
    ...
    /**
     * tableColumnCodigoNotaFiscalTodas usado para mostrar o código de todas as notas fiscais
     */
    @FXML
    ...
    /**
     * tableColumnCodigoNotaFiscalDia usado para mostrar o código das notas fiscais de um dia específico
     */
    @FXML
    private TableColumn<NotaFiscal, Integer> tableColumnCodigoNotaFiscalDia;

    /**
     * tableColumnDataNotaFiscalDia usado para mostrar a data das notas fiscais de um dia específico
     */
    @FXML
    private TableColumn<NotaFiscal, Calendar> tableColumnDataNotaFiscalDia;

    /**
     * tableColumnTotalVendidoNotaFiscalDia usado para mostrar o total vendido das notas fiscais de um dia específico
     */
    @FXML
    private TextField textFieldTotalVendidoNotaDia;

    /**
     * tableColumnTotalVendidoNotaFiscalTodas usado para mostrar o total vendido de todas as notas fiscais
     */
    @FXML
    ...
    /**
     * textFieldTotalVendidoNota usado para mostrar o total vendido de uma nota fiscal
     */
    @FXML
    ...
    /**
     * paneInformacoesTodasNotas usado para mostrar as informações de todas as notas fiscais
     */
    @FXML
    ...
    /**
     * informacoesTodasNotasFiscais usado para mostrar as informações de todas as notas fiscais
     */
    private boolean informacoesTodasNotasFiscais = true;

    /**
     * informacoesDiaEspecifico usado para mostrar as informações de um dia específico
     */
    ...
    /**
     * initialize usado para inicializar a coluna nome, preço, quantidade e descrição da tabela de produtos
     */
    @FXML
    void initialize() {
    ...
    /**
     * informacaoTodasNotas usado para mostrar as informações de todas as notas fiscais
     * @param event evento de clicar no botão
     */
    @FXML
    void informacaoTodasNotas(ActionEvent event) {
        ...
        try {
            if(paneTodasNotas.isVisible()) {
                ...
                if(listaNotaFiscal.getListaNotaFiscal().size() == 0) {
    ...
    /**
     * informacaoDiaEspecifico usado para mostrar as informações de uma nota fiscal de um dia específico
     * @param event evento de clicar no botão
     */
    @FXML
    ...
    /**
     * procurarNotaFiscalDia usado para procurar uma nota fiscal de um dia específico
     * @param event evento de clicar no botão
     */
    @FXML
    ...
    */
    ...
    void hoverBtnVoltar(MouseEvent event) {
     ...
     /**
     * Efeito de hover ao tirar o mouse no botão de mostrar informações de uma nota fiscal
     * @param event evento de hover ao tirar o mouse no botão
     */
    @FXML
    void notHoverbtnInformacaoNotaFiscal(MouseEvent event) {
     ...
     /**
     * Efeito de hover ao passar o mouse no botão de mostrar informações de uma nota fiscal
    * @param event evento de hover ao passar o mouse no botão
    ...
    /**
     * Efeito de hover ao passar o mouse no botão de mostrar informações de uma nota fiscal de um dia específico
     * @param event evento de hover ao passar o mouse no botão
     */
    @FXML
    void hoverBtnInformacaoDiaEspecifico(MouseEvent event) {
        btnInformacaoDiaEspecifico.setStyle("-fx-background-color: #245823;-fx-cursor: hand; -fx-background-radius: 50;");
    }
    
    /**
     * Efeito de hover ao tirar o mouse no botão de mostrar informações de uma nota fiscal de um dia específico
     * @param event evento de hover ao tirar o mouse no botão
     */
    @FXML
    void notHoverBtnInformacaoDiaEspecifico(MouseEvent event) {
        btnInformacaoDiaEspecifico.setStyle("-fx-background-color: #2b6b2a;-fx-cursor: hand; -fx-background-radius: 50;");
    }

    /**
     * Efeito de hover ao passar o mouse no botão de mostrar informações de todas as notas fiscais
     * @param event evento de hover ao passar o mouse no botão
     */
    @FXML
    ...
    /**
     * Efeito de hover ao tirar o mouse no botão de procurar uma nota fiscal em específico
     * @param event evento de hover ao tirar o mouse no botão
     */
    @FXML
    void notHoverBtnProcurarNotaFiscalUnica(MouseEvent event) {
        btnProcurarNotaFiscalUnica.setStyle("-fx-background-color: #2b6b2a;-fx-cursor: hand; -fx-background-radius: 50;");
    }

    /**
     * Efeito de hover ao passar o mouse no botão de procurar uma nota fiscal em específico
     * @param event evento de hover ao passar o mouse no botão
     */
    @FXML
    void hoverBtnProcurarNotaFiscalUnica(MouseEvent event) {
        btnProcurarNotaFiscalUnica.setStyle("-fx-background-color: #245823;-fx-cursor: hand; -fx-background-radius: 50;");
    }

    /**
     * Efeito de hover ao tirar o mouse no botão de procurar uma nota fiscal em um dia específico
     * @param event evento de hover ao tirar o mouse no botão
     */
    @FXML
    ...
    /**
     * Efeito de hover ao passar o mouse no botão de procurar uma nota fiscal em um dia específico
     * @param event evento de hover ao passar o mouse no botão
     */
    @FXML
